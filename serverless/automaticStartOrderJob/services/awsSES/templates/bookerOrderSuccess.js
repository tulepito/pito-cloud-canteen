...
const bookerOrderSuccess = ({ bookerUser, orderListing }) => {
...
<head>
  ...
  <title>Booker - Order success</title><!--[if (mso 16)]>
    <style type="text/css">
                            ...
                            <table width="100%" cellspacing="0" cellpadding="0" role="presentation"
                              ...
                              <tr>
                                <td class="es-m-txt-l" align="left"
                                  ...
                                  <h1
                                    ...
                                    Tận hưởng tuần ăn ${orderName}</h1>
                                </td>
                              </tr>
                              <tr>
                                <td align="left" style="padding:0;Margin:0">
                              ...
                              <tr>
                                <td align="left" style="padding:0;Margin:0;padding-top:10px">
                                  <p
                                    style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#262626;font-size:14px">
                                    PITO Cloud Canteen thông báo bạn vừa đặt thành công đơn hàng
                                    <strong>${orderName}</strong>.</p>
                                </td>
                              </tr>
                            </table>
                          </td>
                                ...
                                <td align="left" style="padding:0;Margin:0">
                                  <p
                                    ...
                                    <strong><a target="_blank"
                                        href="${viewOrderUrl}"
                                        style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#262626;font-size:14px">Xem
                                        chi tiết đơn hàng</a></strong></p>
                                </td>
                              </tr>
                              <tr>
                                <td align="left" style="padding:0;Margin:0;padding-top:25px">
                                  <p
                                    style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#262626;font-size:14px">
                                    Chúng tôi hy vọng <strong>${bookerName}</strong> sẽ tận hưởng một tuần ăn ngon miệng
                                    và chất lượng.</p>
                                </td>
                              </tr>
                            </table>
...
module.exports = { bookerOrderSuccess, bookerOrderSuccessSubject };
