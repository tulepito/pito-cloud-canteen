...
const participantSubOrderCanceledSubject = (subOrderDate) =>
  `Ngày ăn ${subOrderDate} bị huỷ`;

const participantSubOrderCanceled = ({
  participantUser,
  orderListing,
  timestamp,
}) => {
...
<head>
  ...
  <title>Participant - Sub order is canceled</title><!--[if (mso 16)]>
    <style type="text/css">
                            ...
                            <table width="100%" cellspacing="0" cellpadding="0" role="presentation"
                              ...
                              <tr>
                                <td class="es-m-txt-l" align="left"
                                  ...
                                  <h1
                                    ...
                                    Ngày ăn ${formattedSubOrderDate} của tuần ăn ${orderName}<br>bị huỷ</h1>
                                </td>
                              </tr>
                              <tr>
                                <td align="left" style="padding:0;Margin:0">
                              ...
                              <tr>
                                <td align="left" style="padding:0;Margin:0;padding-top:10px">
                                  <p
                                    style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                    Đừng lo lắng, chúng tôi chỉ muốn thông báo với bạn Ngày ăn
                                    <strong>${formattedSubOrderDate}</strong> của tuần ăn <strong>${orderName}</strong> đã bị huỷ.
                                    Đội ngũ PITO Cloud Canteen và Người đại diện của bạn sẽ sắp xếp để bạn có một trải
                                    nghiệm bữa ăn tốt nhất.</p>
                                </td>
                              </tr>
                              <tr>
                                <td align="left" style="padding:0;Margin:0;padding-top:10px">
                                  <p
                                    ...
                                    Cần xem lại tuần ăn <strong>${orderName}</strong>, ${participantName} chỉ cần
                                    <strong><a target="_blank"
                                        style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:none;color:#262626;font-size:14px;font-family:arial, 'helvetica neue', helvetica, sans-serif"
                                        href="${viewOrderUrl}"><u>xem tuần
                                        ăn</u>.</a></strong></p>
                                </td>
                              </tr>
                            </table>
