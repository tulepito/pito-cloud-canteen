  ...
  return (
    <svg
      ...
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M11.75 16.1551C11.336 16.1551 11 15.8191 11 15.4051V8.07812C11 7.66412 11.336 7.32812 11.75 7.32812C12.164 7.32812 12.5 7.66412 12.5 8.07812V15.4051C12.5 15.8191 12.164 16.1551 11.75 16.1551Z"
        fill="#262626"
      />
      <path
        fillRule="evenodd"
