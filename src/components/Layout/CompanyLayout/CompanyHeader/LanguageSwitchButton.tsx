...
export function LanguageSwitchButton({
  ...
  return (
    <button onClick={handleLanguageSwitch} className="mx-2">
      {lang === 'vi' && (
        <div className="flex items-center gap-2">
          {showLabel && <span className="text-sm">VI</span>}
          <svg
            width="28"
            viewBox="0 -4 28 28"
            fill="none"
      ...
      {lang === 'en' && (
        <div className="flex items-center gap-2">
          {showLabel && <span className="text-sm">EN</span>}
          <svg
            width="28"
            viewBox="0 -4 28 28"
            fill="none"
