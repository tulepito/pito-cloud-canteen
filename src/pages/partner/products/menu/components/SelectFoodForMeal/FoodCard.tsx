...
import { EFoodType, EImageVariants } from '@src/utils/enums';
import {
...
const FoodCard: React.FC<TFoodCardProps> = ({ data }) => {
  ...
  const { foodType = EFoodType.savoryDish, specialDiets = [] } =
        ...
        <div className={css.badges}>
          <RenderWhen condition={!!specialDiets[0]}>
            <div className={css.specialDiet}>
              {getLabelByKey(FOOD_SPECIAL_DIET_OPTIONS, specialDiets[0])}
            </div>
          </RenderWhen>
