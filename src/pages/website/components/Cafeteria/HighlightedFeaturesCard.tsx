...
const HighlightedFeaturesCard = () => {
  ...
  return (
    <div className="flex flex-col md:gap-20 md:pb-16 md:pt-16 md:px-0 px-5 pt-16 gap-10 relative max-w-[1024px] mx-auto">
      {/* Heading */}
      <div className="flex flex-col gap-2 items-center">
        ...
        <h2 className="font-[unbounded] text-2xl md:text-[40px] font-bold w-full md:w-[60%] text-center md:leading-tight">
