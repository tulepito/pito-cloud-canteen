...
const data1 = [
  'Manual order collection every day via Zalo, Excel, or messages',
  'Fixed menus with limited flexibility',
  'Frequent delays, missing meals, and delivery mistakes',
  'No reporting system, scattered invoices, hard to reconcile',
  'The more employees you have, the harder it is to manage',
];

const data2 = [
  {
    icon: <PiLaptop />,
    title: 'Plan once for the entire week through the system',
  },
  {
    icon: <PiForkKnife />,
    title: 'Rotating menus every day, employees choose their own meals',
  },
  {
    icon: <PiUsersThree />,
    title: 'Personalized meal boxes — correct name, correct meal',
  },
  {
    icon: <PiFileText />,
    title: 'Transparent tracking of costs and invoices, auto-generated reports',
  },
  {
    icon: <PiBuildingApartment />,
    title: 'Scales effortlessly from 20 to 300+ employees',
  },
];
