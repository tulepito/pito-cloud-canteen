...
const bookerOrderCreated = ({
  ...
  const { startDate, endDate, memberAmount, packagePerMember } =
  ...
  const editOrderUrl = `${BASE_URL}/company/booker/orders/draft/${orderId}`;
...
<head>
  ...
  <title>Booker - Order created</title><!--[if (mso 16)]>
    <style type="text/css">
                            ...
                            <table width="100%" cellspacing="0" cellpadding="0" role="presentation"
                              ...
                              <tr>
                                <td class="es-m-txt-l" align="left"
                                  ...
                                  <h1
                                    ...
                                    Bạn vừa nhận được một đơn hàng tạo bởi PITO</h1>
                                </td>
                              </tr>
                              <tr>
                                <td align="left" style="padding:0;Margin:0">
                              ...
                              <tr>
                                <td align="left" style="padding:0;Margin:0;padding-top:10px">
                                  <p
                                    style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#262626;font-size:14px">
                                    Đơn hàng <strong>${orderName}</strong>&nbsp;của <strong>${bookerName}</strong> vừa
                                    được PITO khởi tạo. Bạn có thể xem chi tiết và chỉnh sửa đơn hàng bằng cách thao
                                    tác:</p>
                                </td>
                              </tr>
                            </table>
                        ...
                        <tr>
                          <td align="left" style="padding:0;Margin:0;width:560px">
                            <table cellpadding="0" cellspacing="0" width="100%" role="presentation"
                              style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                              <tr>
                                <td align="center" class="es-m-txt-c" style="padding:0;Margin:0"><!--[if mso]><a href="${editOrderUrl}" target="_blank" hidden>
	<v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" esdevVmlButton href="${editOrderUrl}" 
                style="height:43px; v-text-anchor:middle; width:167px" arcsize="19%" stroke="f"  fillcolor="#ef3d2a">
		<w:anchorlock></w:anchorlock>
		<center style='color:#ffffff; font-family:arial, "helvetica neue", helvetica, sans-serif; font-size:15px; font-weight:400; line-height:15px;  mso-text-raise:1px'>Chỉnh sửa đơn</center>
	</v:roundrect></a>
<![endif]--><!--[if !mso]><!-- --><span class="msohide es-button-border"
                                    style="border-style:solid;border-color:#2CB543;background:#ef3d2a;border-width:0px;display:inline-block;border-radius:8px;width:auto;mso-border-alt:10px;mso-hide:all"><a
                                      href="${editOrderUrl}" class="es-button es-button-1681700728209 msohide"
                                      target="_blank"
                              ...
                              <tr>
                                <td align="left"
                                  ...
                                  <p
                                    ...
                                    <strong>Chi tiết đơn hàng dự kiến/ngày</strong></p>
                                </td>
                              </tr>
                              <tr>
                                  ...
                                  <table cellpadding="0" cellspacing="0" width="100%" class="es-menu"
                                    ...
                                    <tr class="links">
                                      ...
                                      <td align="left" valign="top" width="50%" id="esd-menu-id-1"
                                        ...
                                        <a target="_blank" href=""
                                          style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:none;display:block;font-family:arial, 'helvetica neue', helvetica, sans-serif;color:#262626;font-size:14px;font-weight:bold">${formattedTotalPrice}</a></td>
                                    </tr>
                                  </table>
                                </td>
                              </tr>
                            ...
                            <table cellpadding="0" cellspacing="0" width="100%"
                              ...
                              <tr>
                                <td align="left" style="padding:0;Margin:0;padding-top:5px;padding-left:20px">
                                  <p
                                    style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#262626;font-size:14px">
                                    <strong>${formattedPackagePerMember}</strong></p>
                                </td>
                              </tr>
                              <tr>
                                <td align="left" style="padding:0;Margin:0;padding-top:10px;padding-left:20px">
                              ...
                              <tr>
                                <td align="left"
                                  ...
                                  <p
                                    style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#262626;font-size:14px">
                                    <strong>${formattedTotalPrice}</strong></p>
                                </td>
                              </tr>
                            </table>
                          </td>
...
export default bookerOrderCreated;
