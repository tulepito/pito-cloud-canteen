...
type PartnerSubOrderIsCanceledParams = {
  companyUser: any;
  orderListing: any;
...
const partnerSubOrderIsCanceled = ({
  ...
  restaurantListing,
  timestamp,
}: PartnerSubOrderIsCanceledParams) => {
...
<head>
  ...
  <title>Partner - Sub order is canceled</title><!--[if (mso 16)]>
    <style type="text/css">
                            ...
                            <table width="100%" cellspacing="0" cellpadding="0" role="presentation"
                              ...
                              <tr>
                                <td class="es-m-txt-l" align="left"
                                  ...
                                  <h1
                                    ...
                                    Ngày ăn ${formattedSubOrderDate} của tuần ăn ${orderName} bị huỷ</h1>
                                </td>
                              </tr>
                              <tr>
                                <td align="left" style="padding:0;Margin:0">
                              ...
                              <tr>
                                <td align="left" style="padding:0;Margin:0;padding-top:10px">
                                  <p
                                    style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#262626;font-size:14px">
                                    PITO Cloud Canteen rất tiếc thông báo, ngày ăn <strong>${formattedSubOrderDate}</strong> của
                              ...
                              <tr>
                                <td align="left" style="padding:0;Margin:0;padding-top:10px">
                                  <p
                                    style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#262626;font-size:14px">
                                    Ngày ăn <strong>${formattedSubOrderDate}</strong> bị huỷ, đồng nghĩa với việc Đối tác sẽ không
                                    cung cấp bữa ăn cho khách hàng <strong>${companyName}</strong>.</p>
                                </td>
                              </tr>
                            </table>
                          </td>
...
export default partnerSubOrderIsCanceled;
