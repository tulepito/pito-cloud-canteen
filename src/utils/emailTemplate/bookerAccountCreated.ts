...
type BookerAccountCreatedParams = {
  companyUser: any;
  password: string;
};
...
<head>
  ...
  <title>Booker - Account created</title><!--[if (mso 16)]>
    <style type="text/css">
  ...
  <style type="text/css">
    ...
    @media only screen and (max-width:600px) {
      ...
      *[class="gmail-fix"] {
      ...
      .login-fixed-width-mobile td.cell-1 {
        width: 40% !important
      }

      .login-fixed-width-mobile td.cell-2 {
        width: 60% !important
      }
                              ...
                              <tr>
                                <td class="es-m-txt-l" align="left"
                                  ...
                                  <h1
                                    ...
                                    Tài khoản của bạn đã sẵn sàng để sử dụng</h1>
                                </td>
                              </tr>
                              <tr>
                                <td align="left" style="padding:0;Margin:0">
                                  <p
                                    ...
                                    Xin chào, <strong>${bookerName}</strong></p>
                                </td>
                              </tr>
                              <tr>
                                <td align="left" style="padding:0;Margin:0;padding-top:10px">
                                  <p
                                    style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                    Tài khoản của bạn tại hệ thống PITO Cloud Canteen đã được khởi tạo và sẵn sàng để sử
                                    dụng. Vui lòng đăng nhập để bắt đầu trải nghiệm dịch vụ PITO Cloud Canteen nhé.</p>
                                </td>
                              </tr>
                            </table>
                          </td>
                      ...
                      <table cellpadding="0" cellspacing="0" width="100%"
                        ...
                        <tr>
                          <td align="center" valign="top" style="padding:0;Margin:0;width:520px">
                            <table cellpadding="0" cellspacing="0" width="100%"
                              style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;border-left:1px solid #bfbfbf"
                              role="presentation">
                              <tr>
                                <td style="padding:0;Margin:0">
                                  <table cellpadding="0" cellspacing="0" width="100%"
                                    class="es-menu login-fixed-width-mobile" role="presentation"
                                    style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                    <tr class="links">
                                      <td align="left" valign="top" width="20%" class="cell-1"
                                        style="Margin:0;padding-left:20px;padding-right:5px;padding-top:0px;padding-bottom:5px;border:0"
                                        id="esd-menu-id-0"><a target="_blank" href=""
                                          style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:none;display:block;font-family:arial, 'helvetica neue', helvetica, sans-serif, Arial, 'helvetica neue', helvetica, sans-serif;color:#8c8c8c;font-size:14px">Tài
                                          khoản</a></td>
                                      <td align="left" valign="top" width="80%" class="cell-2"
                                        style="Margin:0;padding-left:5px;padding-right:5px;padding-top:0px;padding-bottom:5px;border:0;word-break:break-all;font-weight:bold"
                                        id="esd-menu-id-1"><a target="_blank" href=""
                                          style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:none;display:block;font-family:arial, 'helvetica neue', helvetica, sans-serif, Arial, 'helvetica neue', helvetica, sans-serif;color:#262626;font-size:14px">${companyEmail}</a>
                                      </td>
                                    </tr>
                                  </table>
                                </td>
                              ...
                              <tr>
                                <td style="padding:0;Margin:0">
                                  <table cellpadding="0" cellspacing="0" width="100%"
                                    ...
                                    <tr class="links">
                                      <td align="left" valign="top" width="20%" class="cell-1"
                                        style="Margin:0;padding-left:20px;padding-right:5px;padding-top:5px;padding-bottom:0px;border:0"
                                        id="esd-menu-id-0"><a target="_blank" href=""
                                          style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:none;display:block;font-family:arial, 'helvetica neue', helvetica, sans-serif, Arial, 'helvetica neue', helvetica, sans-serif;color:#8c8c8c;font-size:14px">Mật
                                          khẩu</a></td>
                                      <td align="left" valign="top" width="80%" class="cell-2"
                                        style="Margin:0;padding-left:5px;padding-right:5px;padding-top:5px;padding-bottom:0px;border:0;font-weight:bold"
                                        id="esd-menu-id-1"><a target="_blank" href=""
                                          style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:none;display:block;font-family:arial, 'helvetica neue', helvetica, sans-serif, Arial, 'helvetica neue', helvetica, sans-serif;color:#262626;font-size:14px">${password}</a>
                                      </td>
                                    </tr>
                                  </table>
                                </td>
                        ...
                        <tr>
                          <td align="center" valign="top" style="padding:0;Margin:0;width:560px">
                            <table cellpadding="0" cellspacing="0" width="100%" role="presentation"
                              style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                              <tr>
                                <td align="center" class="es-m-txt-c" style="padding:0;Margin:0"><!--[if mso]><a href="${loginUrl}" target="_blank" hidden>
	<v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" esdevVmlButton href="${loginUrl}" 
                style="height:43px; v-text-anchor:middle; width:240px" arcsize="19%" stroke="f"  fillcolor="#ef3d2a">
		<w:anchorlock></w:anchorlock>
		<center style='color:#ffffff; font-family:arial, 'helvetica neue', helvetica, sans-serif; font-size:15px; font-weight:400; line-height:15px;  mso-text-raise:1px'>Đăng nhập</center>
	</v:roundrect></a>
                      ...
                      <table cellpadding="0" cellspacing="0" width="100%"
                        ...
                        <tr class="es-mobile-hidden">
                          <td align="center" valign="top"
                            style="padding:0;Margin:0;border-radius:12px;overflow:hidden;width:520px">
                            <table cellpadding="0" cellspacing="0" width="100%"
                              style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:separate;border-spacing:0px;border-left:1px solid #e6e6e6;border-right:1px solid #e6e6e6;border-top:1px solid #e6e6e6;border-bottom:1px solid #e6e6e6;border-radius:12px;background-color:#fafafa"
                              ...
                              <tr>
                                <td align="left"
                                  ...
                                  <p
                                    ...
                                    <strong>Thông tin về tài khoản</strong>
                                  </p>
                                </td>
                              </tr>
                              <tr>
                                  ...
                                  <table cellpadding="0" cellspacing="0" width="100%" class="es-menu"
                                    ...
                                    <tr class="links">
                                      ...
                                      <td align="left" valign="top" width="50%"
                                        ...
                                        id="esd-menu-id-1"><a target="_blank" href=""
                                          style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:none;display:block;font-family:arial, 'helvetica neue', helvetica, sans-serif;color:#8c8c8c;font-size:14px">Người
                                          đại diện</a></td>
                                    </tr>
                                  </table>
                                </td>
                                  ...
                                  <table cellpadding="0" cellspacing="0" width="100%" class="es-menu"
                                    ...
                                    <tr class="links">
                                      <td align="left" valign="top" width="50%"
                                        ...
                                        id="esd-menu-id-0"><a target="_blank" href=""
                                          style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:none;display:block;font-family:arial, 'helvetica neue', helvetica, sans-serif;color:#262626;font-size:14px;font-weight:bold">${companyName}</a></td>
                                      <td align="left" valign="top" width="50%" id="esd-menu-id-1"
                                        ...
                                        <a target="_blank" href=""
                                          style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:none;display:block;font-family:arial, 'helvetica neue', helvetica, sans-serif;color:#262626;font-size:14px;font-weight:bold">${bookerName}</a>
                                      </td>
                                    </tr>
                                  </table>
                                </td>
                                  ...
                                  <table cellpadding="0" cellspacing="0" width="100%" class="es-menu"
                                    ...
                                    <tr class="links">
                                      <td align="left" valign="top" width="100%"
                                        style="Margin:0;padding-left:25px;padding-right:5px;padding-top:12px;padding-bottom:0px;border:0"
                                        id="esd-menu-id-0"><a target="_blank" href=""
                              ...
                              <tr>
                                <td style="padding:0;Margin:0">
                                  <table cellpadding="0" cellspacing="0" width="100%" class="es-menu"
                                    ...
                                    <tr class="links">
                                      <td align="left" valign="top" width="100%"
                                        style="Margin:0;padding-left:24px;padding-right:5px;padding-top:0px;padding-bottom:25px;border:0"
                                        id="esd-menu-id-0"><a target="_blank" href=""
                                          style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:none;display:block;font-family:arial, 'helvetica neue', helvetica, sans-serif;color:#262626;font-size:14px;font-weight:bold">${companyAddress}</a></td>
                                    </tr>
                                  </table>
                                </td>
                              </tr>
                        ...
                        <tr class="es-desk-hidden"
                          ...
                          <td align="center" valign="top"
                            ...
                            <table cellpadding="0" cellspacing="0" width="100%"
                              ...
                              <tr>
                                <td align="left" style="padding:0;Margin:0;padding-top:5px;padding-left:20px;padding-bottom:25px;padding-right:20px;">
                                  <p
                                    style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
            ...
            <tr>
              <td align="center" style="padding:0;Margin:0">
                <table bgcolor="#ffffff" class="es-content-body" align="center" cellpadding="0" cellspacing="0"
                  style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#FFFFFF;width:600px">
                  <tr>
                    <td class="es-m-p15" align="left" style="padding:35px;Margin:0">
                      <table width="100%" cellspacing="0" cellpadding="0"
                        style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                        <tr>
                          <td class="es-m-p20b" align="left" style="padding:0;Margin:0;width:530px">
                            <table width="100%" cellspacing="0" cellpadding="0" role="presentation"
                              style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                              <tr>
                                <td valign="top" align="left" style="padding:0;Margin:0;width:40px;font-size:0px"><img
                                    src="https://vpldml.stripocdn.email/content/guids/CABINET_2614e981d3fd0c3d11f5fb35a2cbeb4a3fce20e5af507a43e104666c9504ba4a/images/food.png"
                                    alt
                                    style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic"
                                ...
                                <td align="left" style="padding:0;Margin:0">
                                  <table width="100%" cellspacing="0" cellpadding="0" role="presentation"
                                    ...
                                    <tr>
                                      <td align="left" style="padding:0;Margin:0">
                                        <h4
                                          style="Margin:0;line-height:21px;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif, arial, 'helvetica neue', helvetica, sans-serif;font-size:14px">
                                          CÂU CHUYỆN VỀ PITO CLOUD CANTEEN&nbsp;</h4>
                                      </td>
                                    </tr>
                                  </table>
                                </td>
                        ...
                        <tr>
                          <td valign="top" align="center" style="padding:0;Margin:0;width:530px">
                            <table
                              ...
                              width="100%" cellspacing="0" cellpadding="0" bgcolor="transparent" role="presentation">
                              <tr>
                                <td align="left" style="padding:0;Margin:0;padding-top:10px">
                                  <p
                                    ...
                                    Chúng tôi thân mời <strong>${bookerName}</strong> cùng đọc <strong><a target="_blank"
                                        style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#262626;font-size:14px"
                                        href="${developJourneyUrl}">hành trình phát triển</a></strong> của Đội
                                    ngũ và Sản phẩm PITO Cloud Canteen.</p>
                                </td>
                              </tr>
                            </table>
                          </td>
                  ...
                  <tr>
                    <td class="es-m-p15" align="left" style="padding:0;Margin:0;padding-left:35px;padding-right:35px">
                      <table width="100%" cellspacing="0" cellpadding="0"
                        style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                        <tr>
                          <td class="es-m-p20b" align="left" style="padding:0;Margin:0;width:530px">
                            <table width="100%" cellspacing="0" cellpadding="0" role="presentation"
                              ...
                              <tr>
                                <td valign="top" align="left" style="padding:0;Margin:0;width:40px;font-size:0px"><img
                                    src="https://vpldml.stripocdn.email/content/guids/CABINET_2614e981d3fd0c3d11f5fb35a2cbeb4a3fce20e5af507a43e104666c9504ba4a/images/receipt.png"
                                    alt
                                    style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic"
                                    width="20" height="20"></td>
                                <td align="left" style="padding:0;Margin:0">
                            ...
                            <table
                              ...
                              <tr>
                                <td align="left" style="padding:0;Margin:0;padding-top:10px">
                                  <p
                                    style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#262626;font-size:14px">
                                    Truy cập <strong><a target="_blank"
                                        style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#262626;font-size:14px"
                                        href="${termOfServiceUrl}">Điều khoản điều kiện</a></strong> để nắm
                                    các quy định khi tham gia sử dụng dịch vụ của PITO Cloud Canteen</p>
                                </td>
                              </tr>
                            </table>
                          </td>
...
export default bookerAccountCreated;
