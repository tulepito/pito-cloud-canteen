...
export const bookerPickingOrderChangedSubject = 'Đơn hàng có sự thay đổi';

type TBookerPickingOrderChangedParams = {
...
const bookerPickingOrderChanged = ({
  formattedStartDate = '',
  formattedEndDate = '',
  bookerName = '',
  deliveryHour,
                              ...
                              <tr>
                                <td align="left" style="padding:0;Margin:0">
                                  <p
                                    ...
                                    ${oldTitleMaybe} <strong>${oldContentMaybe}</strong></p>
                                </td>
                              </tr>
                            </table>
                          </td>
                            ...
                            <table cellpadding="0" cellspacing="0" width="100%" role="presentation"
                              ...
                              <tr>
                                <td align="left" style="padding:0;Margin:0">
                                  <p
                                    style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                    ${newTitleMaybe} <strong>${newContentMaybe}</strong></p>
                                </td>
                              </tr>
                            </table>
                          </td>
...
<head>
  ...
  <title>Booker - Picking order changed</title><!--[if (mso 16)]>
<style type="text/css">
                            ...
                            <table width="100%" cellspacing="0" cellpadding="0" role="presentation"
                              ...
                              <tr>
                                <td class="es-m-txt-l" align="left"
                                  ...
                                  <h1
                                    ...
                                    Tuần ăn ${formattedStartDate}-${formattedEndDate} có sự thay đổi&nbsp;</h1>
                                </td>
                              </tr>
                              <tr>
                              ...
                              <tr>
                                <td align="left" style="padding:0;Margin:0;padding-top:5px">
                                  <p
                                    style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                    Tuần ăn <strong>${formattedStartDate}-${formattedEndDate}</strong> được giao lúc
                                    <strong>${deliveryHour}</strong> vừa được chỉnh sửa. ${bookerName} vui lòng cập nhật
                                    lại thông tin đơn hàng nhé.</p>
                                </td>
                              </tr>
                            </table>
                          </td>
...
style="height:43px; v-text-anchor:middle; width:337px" arcsize="19%" stroke="f" fillcolor="#ef3d2a">
<w:anchorlock></w:anchorlock>
<center style='color:#ffffff; font-family:arial, "helvetica neue", helvetica, sans-serif; font-size:15px; font-weight:400; line-height:15px; mso-text-raise:1px'>Xem chi tiết đơn hàng mới</center>
</v:roundrect></a>
            ...
            <tr>
              <td align="center" style="padding:0;Margin:0">
                <table class="es-content-body" cellspacing="0" cellpadding="0" bgcolor="#ffffff" align="center"
                  ...
                  <tr>
                    <td class="esdev-adapt-off es-m-p15r es-m-p15l" align="left"
                      style="padding:0;Margin:0;padding-right:20px;padding-left:40px">
                      <!--[if mso]><table style="width:540px" cellpadding="0" cellspacing="0"><tr><td style="width:260px" valign="top"><![endif]-->
                      <table cellspacing="0" cellpadding="0" align="left" class="es-left" role="none"
                        style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;float:left">
                        <tr>
...
export default bookerPickingOrderChanged;
