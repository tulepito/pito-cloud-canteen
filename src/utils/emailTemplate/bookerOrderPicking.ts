...
import { calculateRemainTime, formatTimestamp } from '../dates';

const BASE_URL = process.env.NEXT_PUBLIC_CANONICAL_URL;

type BookerOrderPickingParams = {
  bookerUser: any;
  companyUser: any;
  orderListing: any;
};
...
const bookerOrderPicking = ({
  ...
  const shareUrl = `${BASE_URL}/participant/order/${orderId}`;
...
export default bookerOrderPicking;
