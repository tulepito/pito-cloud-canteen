...
type BookerAccountSuspendedParams = {
  companyUser: any;
  suspendedTimestamp: number;
};
export const bookerAccountSuspendedSubject = 'Tài khoản bị tạm ngưng hoạt động';

const bookerAccountSuspended = ({
  companyUser,
  suspendedTimestamp,
}: BookerAccountSuspendedParams) => {
  const { displayName: bookerName } = companyUser.getProfile();

  const formattedSuspendedDate = formatTimestamp(suspendedTimestamp);
  const reActiveUrl = 'https://cloudcanteen.pito.vn';
...
<head>
  ...
  <title>Booker - Account suspended</title><!--[if (mso 16)]>
    <style type="text/css">
                            ...
                            <table width="100%" cellspacing="0" cellpadding="0" role="presentation"
                              ...
                              <tr>
                                <td class="es-m-txt-l" align="left"
                                  ...
                                  <h1
                                    ...
                                    Rất tiếc! Tài khoản của bạn đã tạm ngưng!</h1>
                                </td>
                              </tr>
                              <tr>
                                <td align="left" style="padding:0;Margin:0">
                              ...
                              <tr>
                                <td align="left" style="padding:0;Margin:0;padding-top:10px">
                                  <p
                                    style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#262626;font-size:14px">
                                    Chúng tôi rất tiếc thông báo rằng, tài khoản đăng ký dịch vụ PITO Cloud Canteen đã
                                    tạm ngưng vào ngày ${formattedSuspendedDate}.</p>
                                </td>
                              </tr>
                              <tr>
                                <td align="left" style="padding:0;Margin:0;padding-top:10px">
                                  <p
                                    style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#262626;font-size:14px">
                                    Khi tài khoản tạm ngưng, <strong>${bookerName}</strong> sẽ không thể tiếp tục sử dụng
                                    dịch vụ đặt cơm văn phòng hoặc nhận thông báo trong thời gian sắp tới. Nếu bạn muốn
                                    đăng ký lại, chỉ cần thao tác nhanh bằng cách nhấp chuột vào chữ <strong>“Đăng ký
                                      lại”</strong></p>
                                </td>
                              </tr>
                            </table>
                        ...
                        <tr>
                          <td align="center" valign="top" style="padding:0;Margin:0;width:560px">
                            <table cellpadding="0" cellspacing="0" width="100%" role="presentation"
                              style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                              <tr>
                                <td align="center" class="es-m-txt-c" style="padding:0;Margin:0"><!--[if mso]><a href="${reActiveUrl}" target="_blank" hidden>
	<v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" esdevVmlButton href="${reActiveUrl}" 
                style="height:43px; v-text-anchor:middle; width:238px" arcsize="19%" stroke="f"  fillcolor="#ef3d2a">
		<w:anchorlock></w:anchorlock>
		<center style='color:#ffffff; font-family:arial, 'helvetica neue', helvetica, sans-serif; font-size:15px; font-weight:400; line-height:15px;  mso-text-raise:1px'>Đăng ký lại</center>
	</v:roundrect></a>
<![endif]--><!--[if !mso]><!-- --><span class="msohide es-button-border"
                                    style="border-style:solid;border-color:#2CB543;background:#ef3d2a;border-width:0px;display:inline-block;border-radius:8px;width:auto;mso-border-alt:10px;mso-hide:all"><a
                                      href="${reActiveUrl}" class="es-button msohide es-button-1"
                                      target="_blank"
                            ...
                            <table cellpadding="0" cellspacing="0" width="100%" role="presentation"
                              ...
                              <tr>
                                <td align="left" style="padding:0;Margin:0">
                                  <p
                                    style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#262626;font-size:14px">
                                    Chúng tôi hy vọng sẽ chào đón <strong>${bookerName}</strong> sớm quay trở lại.</p>
                                </td>
                              </tr>
                            </table>
                          </td>
...
export default bookerAccountSuspended;
